...
MANIFEST="DTROverlay/DTROverlay.json"
...
DOWNLOAD_URL="https://github.com/exatrines/DTROverlay/releases/download/${TAG}/DTROverlay.zip"
...
path = pathlib.Path("DTROverlay/DTROverlay.csproj")
...
echo "  $MANIFEST"
echo "  DTROverlay/DTROverlay.csproj (<Version>${CSPROJ_VERSION}</Version>)"
echo ""
echo "Update pluginmaster.json in your external repo separately."
echo ""
echo "Next:"
echo "  git add $MANIFEST DTROverlay/DTROverlay.csproj CHANGELOG.md"
